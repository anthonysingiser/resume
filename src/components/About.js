...
const About = (props) => {
  ...
  const github = info.profiles.find(profile => profile.network === 'Github')
  ...
  return (
    <div className="section mt-2">
      <div className="flex items-center justify-center">
        ...
        <Link href={github.url} className="relative z-10">
          <Image className="w-20 h-20 md:w-16 md:h-16 rounded-full ring-4 ring-green-400 ring-offset-2 dark:ring-offset-gray-900" src={info.image} alt={`Picture of ${info.name}`} width={500} height={300} />
        </Link>
